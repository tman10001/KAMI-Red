...
import org.kamired.client.util.EntityUtils.mobTypeSettings
import org.kamired.client.util.color.HueCycler
...
internal object Chams : Module(
    ...
    private val crystals by setting("Crystals", true, { page == Page.ENTITY_TYPE && !all })
    ...
    private val texture by setting("Texture", true, { page == Page.RENDERING })
