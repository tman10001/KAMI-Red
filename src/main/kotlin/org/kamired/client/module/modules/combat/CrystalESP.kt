...
import org.kamired.client.event.events.RenderOverlayEvent
...
import org.kamired.client.util.Quad
...
import org.kamired.client.util.graphics.GlStateUtils
...
internal object CrystalESP : Module(
    ...
    private val tracer = setting("Tracer", false, { page.value == Page.CRYSTAL_ESP && crystalESP.value })
    private val showDamage = setting("Damage", false, { page.value == Page.CRYSTAL_ESP && crystalESP.value })
    private val showSelfDamage = setting("Self Damage", false, { page.value == Page.CRYSTAL_ESP && crystalESP.value })
    ...
    private val color by setting("Color", ColorHolder(0, 0, 0), false, { page.value == Page.CRYSTAL_ESP_COLOR && crystalESP.value })
