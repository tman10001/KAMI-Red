...
import org.kamired.client.manager.managers.HotbarManager
import org.kamired.client.manager.managers.HotbarManager.resetHotbar
import org.kamired.client.manager.managers.HotbarManager.serverSideItem
import org.kamired.client.manager.managers.HotbarManager.spoofHotbar
import org.kamired.client.manager.managers.PlayerPacketManager
import org.kamired.client.manager.managers.PlayerPacketManager.sendPlayerPacket
import org.kamired.client.mixin.extension.id
import org.kamired.client.mixin.extension.packetAction
import org.kamired.client.module.Category
import org.kamired.client.module.Module
import org.kamired.client.util.*
import org.kamired.client.util.combat.CombatUtils.equipBestWeapon
import org.kamired.client.util.combat.CombatUtils.scaledHealth
import org.kamired.client.util.combat.CrystalUtils.canPlaceCollide
import org.kamired.client.util.combat.CrystalUtils.getCrystalBB
import org.kamired.client.util.combat.CrystalUtils.getCrystalList
import org.kamired.client.util.items.*
import org.kamired.client.util.math.RotationUtils
import org.kamired.client.util.math.RotationUtils.getRotationTo
import org.kamired.client.util.math.RotationUtils.getRotationToEntity
import org.kamired.client.util.math.VectorUtils.distanceTo
import org.kamired.client.util.math.VectorUtils.toBlockPos
import org.kamired.client.util.math.VectorUtils.toVec3d
import org.kamired.client.util.math.VectorUtils.toVec3dCenter
...
import org.kamired.client.util.world.getClosestVisibleSide
