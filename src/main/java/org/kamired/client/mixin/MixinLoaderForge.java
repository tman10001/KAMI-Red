package org.kamired.client.mixin;
 ...
 */
@IFMLLoadingPlugin.Name("KAMIRedMixinLoader")
...
public class MixinLoaderForge implements IFMLLoadingPlugin {
    ...
    public MixinLoaderForge() {
        log.info("KAMI Red and Baritone mixins initializing...");
        ...
        log.info("KAMI Red and Baritone mixins initialised.");
